          ...
          <Reveal direction="from-bottom">
            <div className="flex justify-center mt-12">
              <a
                ...
                className="group flex items-center gap-3 px-8 py-4 rounded-2xl border-2 border-pink-300 bg-white hover:bg-gradient-to-r hover:from-pink-500 hover:to-rose-500 shadow-[0_4px_20px_rgba(236,72,153,0.15)] hover:shadow-[0_8px_32px_rgba(236,72,153,0.35)] transition-all duration-300 hover:border-transparent hover:text-white hover:scale-105"
              >
                {/* Instagram icon */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  className="h-6 w-6 text-pink-500 group-hover:text-white transition-colors duration-300">
                ...
                <div className="text-left">
                  <p className="font-playfair font-bold text-base text-foreground group-hover:text-white transition-colors duration-300">For More Posts</p>
                  <p className="text-xs text-muted-foreground group-hover:text-white/80 transition-colors duration-300">Visit us on Instagram @firdaus_makeover</p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"
                  className="h-5 w-5 text-pink-400 group-hover:text-white group-hover:translate-x-1 transition-all duration-300">
